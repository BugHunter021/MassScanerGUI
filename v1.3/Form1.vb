...
Public Class form1
    ...
    Private Sub btnscan_Click(sender As Object, e As EventArgs) Handles btnscan.Click
        If Not (ScanST) Then
            If lblcountip.Text = "0" Then
                MsgBox("No ip for scan.first create ip list", MessageBoxIcon.Error)
            Else
                If My.Computer.FileSystem.FileExists("masscan.exe") Then
                    ...
                    ScanST = True
                Else
                    MsgBox("Cannot find masscan.exe.please copy ""Scanner GUI"" in MassScan folder", MessageBoxIcon.Error)
                End If
            End If
        Else
    ...
    Private Sub btnresum_Click(sender As Object, e As EventArgs) Handles btnresum.Click
        If Not (ScanST) Then
            If My.Computer.FileSystem.FileExists("masscan.exe") Then
                btnresum.Enabled = False
                btnparser.Enabled = False

                Dim argmas = "--resume paused.conf"
    ...
    Private Sub btnparser_Click(sender As Object, e As EventArgs) Handles btnparser.Click
        ...
        If My.Computer.FileSystem.FileExists("output.txt") Then
            ...
            Shell("notepad.exe outparser.txt", AppWinStyle.NormalFocus)
            'MsgBox("Parser finished and save to file : ""outparser.txt"" ", MessageBoxIcon.Asterisk)
        Else
            MsgBox("cannot find ""output.txt"" for parser", MessageBoxIcon.Stop)
        End If
    End Sub
